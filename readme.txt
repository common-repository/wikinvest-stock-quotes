...
Tested up to: 2.9.2
Tags: Wikinvest, finance, investing, quote suggest, stock quotes, quotes, tickers, widget, quotes collection, quotes, quotations, plugin, sidebar, php?
Stable Tag: 1.03
...
* **Background research** - Good, free, background research for your readers, ticker symbols next to the stock quote will link back to [Wikinvest](http://www.wikinvest.com) articles.
...
7. For instructions on how to use the plugin, [click here](http://www.wikinvest.com/blogger/Wikinvest_stockquotes/howtouse), or click the *Other Notes* tab (if available)
...
Yes. Please see the Wikinvest Stock Quotes Plugin terms of use [here](http://www.wikinvest.com/site/Wikinvest_Stock_Quotes_Plugin_Terms_of_Use) or in the *Other Notes* tab.
...
1. Example Post with the Wikinvest Stock Quotes Plugin
2. Admin Interface of the Plugin

== Terms of use ==

WIKINVEST STOCK QUOTES TERMS OF USE

By adding the Wikinvest Stock Quote widget (the "Widget") to your website, you agree to be bound by the [Wikinvest Terms of Use](http://www.wikinvest.com/site/Terms_of_Service) and by these additional Widget Terms of Use: 

1. Nvest grants you a personal, non-exclusive license to download, install and run the Widget on your website in a manner consistent with applicable law and with the [Wikinvest Terms of Use](http://www.wikinvest.com/site/Terms_of_Service) (including without limitation all disclaimers and limitations of liability set forth therein) and these Widget Terms of Use. To the extent that these Widget Terms of Use directly conflict with the [Wikinvest Terms of Use](http://www.wikinvest.com/site/Terms_of_Service), these Widget Terms of Use shall control.
